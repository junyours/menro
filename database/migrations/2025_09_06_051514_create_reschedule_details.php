...
return new class extends Migration
{
    ...
    {
        Schema::create('reschedule_details', function (Blueprint $table) {
            $table->id();
            ...
            // Foreign Keys
            $table->foreign('reschedule_id')->references('id')->on('re_schedules')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('reschedule_details');
    }
};
